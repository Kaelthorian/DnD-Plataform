...
9. Si se tocó combate, seguir además `docs/COMBAT.md`: conexión Live Sheet que abre Combat automáticamente, VTT visible solo en `#combatMapViewport`, Hit/Miss/crit, spell save, Magic Missile, cancelación, Extra Attack, End Turn y Reaction fuera de turno.
