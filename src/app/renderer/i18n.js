(function initPlayerI18n(globalScope) {
  ...
  const EN = {
    ...
    "turn.target": "Target (visible name only)",
    "turn.knownAc": "Known AC (optional)",
    ...
    "turn.targetPlaceholder": "Target or Self",
    "turn.hiddenAcPlaceholder": "Leave blank if hidden",
  ...
  const ES = {
    ...
    "turn.category.features": "Features",
    "turn.target": "Objetivo (solo nombre visible)",
    "turn.knownAc": "AC conocida (opcional)",
    ...
    "turn.targetPlaceholder": "Objetivo o Self",
    "turn.hiddenAcPlaceholder": "Dejar vac\u00edo si est\u00e1 oculta",
