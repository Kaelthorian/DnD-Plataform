(function initPlayerI18n(globalScope) {
  ...
  const EN = {
    ...
    "settings.dice3d": "3D dice",
    "settings.dice3dDescription": "Show animated dice on screen",
  ...
  const ES = {
    ...
    "settings.dice3d": "Dados 3D",
    "settings.dice3dDescription": "Mostrar dados animados en pantalla",
  ...
  const LEGACY_PHRASES = {
    ...
    "Dados 3D": "settings.dice3d",
    "Mostrar dados animados en pantalla": "settings.dice3dDescription",
    "Cerrar": "common.close",
